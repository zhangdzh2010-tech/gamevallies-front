...
当前游戏播放页运行在微信小程序端，页面主体使用 `web-view` 加载真实游戏地址。公开站点是 `https://www.zlspace.ai`，作品与壳页在独立 content origin `https://content.zlspace.ai`。游戏原始地址形如：

- `https://content.zlspace.ai/games/...`
...
```text
https://content.zlspace.ai/game-shell/index.html#/pages/game/web-shell/index?id=123&src=%2Fgames%2Fabc123
```

请注意：

- `https://content.zlspace.ai/game-shell/index.html` 是物理存在的 H5 入口地址
...
- `https://content.zlspace.ai/game-shell/index.html`
...
5. 页面可在微信内置浏览器正常打开
6. 最好与真实游戏页同域，即同属 `https://content.zlspace.ai`

### 3.3 不建议使用 hash 路由地址

不建议只提供这种地址：

- `https://content.zlspace.ai/#/pages/game/web-shell/index`
...
- `/games/abc123`
- `https://content.zlspace.ai/games/abc123`
...
- `https://content.zlspace.ai/game-shell/index.html` 可以稳定 iframe 打开 `https://content.zlspace.ai/games/...`
...
```text
https://content.zlspace.ai/game-shell/index.html?gameId=123&src=%2Fgames%2Fabc123&title=%E6%89%93%E5%9C%B0%E9%BC%A0&cover=https%3A%2F%2Fcdn.example.com%2Fcover.png
```
...
- 小程序内打开的壳页和游戏页都在 `content.zlspace.ai` 域下
...
前端实际打开示例：
https://content.zlspace.ai/game-shell/index.html#/pages/game/web-shell/index?id=123&src=%2Fgames%2Fabc123&title=%E6%89%93%E5%9C%B0%E9%BC%A0
...
3. `https://content.zlspace.ai/game-shell/index.html#/pages/game/web-shell/index?...` 可在手机浏览器正常打开
...
```text
TARO_APP_GAME_SHELL_URL=https://content.zlspace.ai/game-shell/index.html
```
...
- 可被微信小程序 `web-view` 打开
- 可通过 `iframe` 嵌入 `https://content.zlspace.ai/games/...`
