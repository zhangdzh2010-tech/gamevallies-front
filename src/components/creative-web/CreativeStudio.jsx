...
export default function CreativeStudio({
  ...
  return <ConversationStudioBody {...{mode, displayTitle, onTitleChange, orientation, onOrientationChange, input, onInputChange, session, work, previewWork, generating, progress, loading, error, primary, secondary, onCancel, onNew, canPlay, onUnlock, quotaText, supplemental, inputAriaLabel, completed, publishing, published, publishError, shareUrl, publish}}><PaywallPopup /></ConversationStudioBody>;
}
